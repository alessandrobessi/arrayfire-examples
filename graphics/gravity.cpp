...
const int total_particles = 4000;
const int reset = 3000;
const float min_dist = 3;
const int width = 768, height = 768, depth = 768;
const int gravity_constant = 20000;
...
int main(int argc, char *argv[])
{
    ...
    {
        af::info();
        af::Window window(width, height, "Gravity Simulation");
        window.setColorMap(AF_COLORMAP_HEAT);
        int frame_count = 0;
